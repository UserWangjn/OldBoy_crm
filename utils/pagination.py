...
class Pagination:
    ...
    def show_li(self):
        # 存放li标签的列表
        html_list = []
        self.query_params['page'] = 1  # query=alex&page=1

        first_li = '<li><a href="{0}?{1}">首页</a></li>'.format(self.base_url, self.query_params)
        ...
        if self.current_page == 1:
            ...
            prev_li = '<li><a href="{1}?{0}"><<</a></li>'.format(self.query_params.urlencode(), self.base_url)
